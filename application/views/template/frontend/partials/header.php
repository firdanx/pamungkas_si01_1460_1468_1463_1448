			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<a href="http://localhost/spk_codeigniter/admin/Auth/login"><span data-hover="Login">Login</span></a><span class="line1">|</span></li>
					</ul>
				</div>
			</div>
        </nav>
    ...
    <div class="jarallax callbacks_container w3-layouts">
      <ul class="rslides callbacks callbacks1 agileits" id="slider4">
        <li id="callbacks1_s1" class="" style="float: none; position: absolute; opacity: 0; z-index: 1; display: list-item; transition: opacity 500ms ease-in-out;">
          ...
          <div class="caption text-center"><h3>Mari Bersama Membangun Pendidikan</h3><p>Pendidikan bukan persiapan untuk hidup. Pendidikan adalah hidup itu sendiri (John Dewey)</p></div>
        </li>
		 <li id="callbacks1_s2" class="" style="float: none; position: absolute; opacity: 0; z-index: 1; display: list-item; transition: opacity 500ms ease-in-out;">
          ...
          <div class="caption text-center"><h3>Mari Bersama Membangun Pendidikan</h3><p>Arah yang diberikan pendidikan untuk mengawali hidup seseorang akan menentukan masa depannya (Plato)</p></div>
        </li>
        <li id="callbacks1_s3" class="callbacks1_on" style="float: left; position: relative; opacity: 1; z-index: 2; display: list-item; transition: opacity 500ms ease-in-out;">
          ...
          <div class="caption text-center"><h3>Mari Bersama Membangun Pendidikan</h3> <p>Seorang Guru menggandeng tangan, membuka pikiran, menyentuh hati, dan membentuk masa depan. Seorang Guru berpengaruh selamanya. Dia tidak pernah tahu kapan pengaruhnya berakhir (Henry Adam)</p></div>
        </li>
		<li id="callbacks1_s6" class="callbacks1_on" style="float: left; position: relative; opacity: 1; z-index: 2; display: list-item; transition: opacity 500ms ease-in-out;">
          ...
          <div class="caption text-center"><h3>Mari Bersama Membangun Pendidikan</h3> <p> Salah satu tanda seorang pendidik yang hebat yakni mampu memimpin murid-murid menjelajahi tempat-tempat baru yang bahkan belum pernah didatangi sang pendidik itu sendiri (Thomas Groome)</p></div>
        </li>
      </ul>
