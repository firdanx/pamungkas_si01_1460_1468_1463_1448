		    <div class="row">
	        	...
	        	<div class="col-sm-3">
	        		...
	        		<div class="tile-stats tile-aqua">
	        			...
	        			<h3>Jumlah Siswa</h3>
	        			<p>Siswa yang terdaftar di Yogyakarta.</p>
	        		</div>
	        ...
	        <div class="row">
				...
				<div class="col-md">
					...
					<div class="panel panel-success" data-collapsed="0">
						...
						<!-- panel head -->
						<div class="panel-heading">
							<div class="panel-title">SPK Penentuan Siswa Unggulan</div>
							<div class="panel-options">								
								<a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
								<a href="#" data-rel="reload"><i class="entypo-arrows-ccw"></i></a>
							</div>
						...
						<!-- panel body -->
						<div class="panel-body" style="text-align: justify;">
							<p>Sistem Pendukung Keputusan Penentuan Siswa Unggulan Tingkat SMA Sederajat Menggunakan Metode Analytical Hierarchy Process 
							adalah sebuah sistem yang bertujuan untuk menentukan Sekolah-sekolah yang ada di Yogyakarta sebagai siswa unggulan.
							Tentu output atau keluaran dari sistem ini hanya sebagai rekomendasi dan perbandingan saja karena
							untuk pemberian siswa unggulan tentu merupakan hak dan wewenang Pemerintah dalam hal ini Dinas Pendidikan
							dimana siswa tersebut memiliki beberapa kriteria yang akan menentukan bahwa siswa tersebut bisa dikatakan sebagai siswa unggulan.
							Sistem ini dibangun menggunakan Framework PHP Codeigniter dan Framework CSS Bootstrap serta didukung oleh bahasa
							Pemrograman Javascript. Sistem ini masih memiliki banyak kekurangan sehingga besar harapan Pengembang untuk mendapatkan
